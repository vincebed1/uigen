...
test("MessageList shows typing indicator when last message is from user", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
  ...
  // Typing indicator should appear because we're waiting for the assistant to respond
  expect(screen.queryByText("Generating...")).toBeDefined();
});
