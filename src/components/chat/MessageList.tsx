...
export function MessageList({ messages, isLoading }: MessageListProps) {
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center flex-1 min-h-[calc(100vh-10rem)] px-4 text-center">
      ...
      <div className="space-y-6 max-w-4xl mx-auto w-full">
        {isLoading && messages[messages.length - 1]?.role === "user" && (
          <div className="flex gap-4 justify-start">
            ...
            <div className="rounded-xl px-4 py-3 bg-white border border-neutral-200 shadow-sm flex items-center gap-2 text-neutral-500">
